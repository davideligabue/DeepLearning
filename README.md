...
If you don't want to retrain the model defined in the notebook you can download the pretrained weights using the cell under the paragraph **Load the weights**.
